            ...
            <form action="/cp/<?=$method?>/" class="form-horizontal onsubmit" data-redirect="/cp/<?=$method?>/">
               <div class="form-body"> 
                  ...
                  <div class="form-group">
                     <label class="control-label col-md-1">Language <span class="required">*</span></label>
                     <div class="col-md-11">
                  ...
                  <div class="tabbable-line">
                     <div class="tab-content" style="background-color:#f7f7f7;"> 
                        <div class="tab-pane active" id="tab_1_1"> 
                           <?=getInputLang(false, $data, 'Название', 'name', 'text', 'input', false, array('label_col' => 'col-md-1', 'field_col' => 'col-md-11'))?>    
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-11">
                                 <select name="id_lang" class="form-control">
                                    <?php foreach ($lang_arr as $key => $value): ?>
                                       <?php 
                                          $selected = $key == $data['id_lang'] ? 'selected' : '';
                                       ?>
